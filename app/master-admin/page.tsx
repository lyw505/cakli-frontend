...
export default function MasterDashboard() {
    ...
    return (
        <div className="flex flex-col gap-4 p-6">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                ...
                <Card className="overflow-hidden">
                    <div className="flex items-stretch h-full">
                        ...
                        <div className="flex-1">
                            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-1 pt-3 px-3">
                                <CardTitle className="text-xs font-medium">Tingkat Pertumbuhan Order</CardTitle>
                                <TrendingUp className="h-3.5 w-3.5 text-muted-foreground" />
                            </CardHeader>
                            <CardContent className="px-3 pb-3">
                                <div className="text-xl font-bold text-cakli-green">+14.3%</div>
                                <p className="text-[10px] text-muted-foreground">MoM Growth · Feb vs Jan</p>
                            </CardContent>
                        </div>
                    </div>
                </Card>
                ...
                <Card className="overflow-hidden">
                    <div className="flex items-stretch h-full">
                        ...
                        <div className="flex-1">
                            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-1 pt-3 px-3">
                                <CardTitle className="text-xs font-medium">System Uptime Rate</CardTitle>
                        ...
                        <CardContent className="space-y-2 px-4 pb-3">
                            <div className="flex items-start gap-2.5 p-2.5 rounded-lg bg-red-50 dark:bg-red-950/20">
                                ...
                                <div className="min-w-0 flex-1">
                                    <p className="text-[11px] font-bold text-red-800 dark:text-red-300">Fraud Suspicion Flag</p>
                            ...
                            <div className="flex items-start gap-2.5 p-2.5 rounded-lg bg-orange-50 dark:bg-orange-950/20">
                                ...
                                <div className="min-w-0 flex-1">
                                    <p className="text-[11px] font-bold text-orange-800 dark:text-orange-300">High Dispute Region</p>
                            ...
                            <div className="flex items-start gap-2.5 p-2.5 rounded-lg bg-yellow-50 dark:bg-yellow-950/20">
                                ...
                                <div className="min-w-0 flex-1">
                                    <p className="text-[11px] font-bold text-yellow-800 dark:text-yellow-300">Abnormal Cancel Spike</p>
            ...
            {/* ===== BENTO ROW 3: Unit Economics + Kebijakan + Indikator Risiko (3 cols) ===== */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                {/* Unit Economic Snapshot */}
                <Card>
                    <CardHeader className="pb-2 pt-3 px-4">
                        <CardTitle className="text-xs font-bold flex items-center gap-1.5">
                            <DollarSign className="size-3.5 text-cakli-orange" /> Unit Economic Snapshot
                        </CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-1.5 px-4 pb-3">
                        {[
                            { label: "Revenue per Order", value: "Rp 18.450", trend: "+2.1%" },
                            { label: "Cost per Order", value: "Rp 12.800", trend: "-0.8%" },
                            { label: "Avg. Driver Payout", value: "80%", trend: null },
                            { label: "Platform Take Rate", value: "20%", trend: null },
                        ].map((item) => (
